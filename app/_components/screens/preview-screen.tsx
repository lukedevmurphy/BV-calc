...
import { DeckSectionSlide, DeckFooter, confidentialLabel } from "../deck-slide";
  ...
  return (
    <div className="mx-auto max-w-[1160px] px-6 py-12">
      ...
      <div className="relative">
        ...
        <div className="w-full overflow-hidden rounded-2xl border-2 border-line-strong bg-canvas shadow-card">
          <ScaledSlide>
            {current.type === "cover" ? (
